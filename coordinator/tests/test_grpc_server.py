...
def _build_servicer(taskgraph_client, *, integration_client=None):
    scheduler = Scheduler(taskgraph_client, integration_client)
    assignment_engine = AssignmentEngine(
        FakeAgentPoolClient(), FakeStateClient(), taskgraph_client
    )
    tradeoff_resolver = TradeoffResolver(FakeStateClient(), FakeAuditClient(), taskgraph_client)
    return CoordinatorServicer(scheduler, assignment_engine, tradeoff_resolver)
