"""Caller allow-list enforcement for the AuditService gRPC server.
...
# before any real caller ever reaches an AuditService method. Exempt both
# the v1alpha service actually registered and the stable v1 name modern
# clients probe first.
