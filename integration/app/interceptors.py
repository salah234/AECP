"""Caller allow-list enforcement for the IntegrationService gRPC server.
...
metadata-based placeholder (mirrors taskgraph/app/interceptors.py,
state/app/interceptors.py, and agents/app/interceptors.py) pending
...
# before any real caller ever reaches an IntegrationService method. Exempt
